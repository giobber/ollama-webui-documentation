...
This documentation contains info about installing, updating and using a **local** AI LLM environment based on [ollama](https://ollama.com/) and [open-webui](https://docs.openwebui.com/) with a similar experience of ChatGPT services.
